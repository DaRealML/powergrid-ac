...
public class CSolver extends ConfigBase {
    ...
    private static class Comments {
        ...
        public static final String splittingTransmissionLines = "Experimental! Allows transmission lines to split large grid into smaller networks. This option should improve performance for large grids but it will result in transmission lines having a propagation delay and capacitance. On alternating current the delay is one solver sub-tick on every split line, and what a sub-tick is worth in degrees depends on the conductor, so the three conductors of a three-phase line are shifted by different angles. Measured on a three-phase supply at 4 Hz and 8 sub-ticks the current is 7.3 degrees out and 4.9 % high at 1 ohm per conductor, and 33.6 degrees out and 60.8 % high at 0.25 ohm, which is just above the default threshold. Leave this off on an AC grid.";
