...
| e_xfmr_bank4 (48 nodes) | 0.3815 | 0.0977 | **3.9x** |
...
`e_xfmr_bank4` is the biggest win outside the required three: four transformer banks in one
48-node sparse island, well inside the fill-reducing ordering's sweet spot.
